...
#      resource_group_id  = data.ibm_resource_group.existing_resource_group.name
...
#   source_resource_group_id = data.ibm_resource_group.existing_resource_group.name
#   target_service_name      = "secrets-manager"
#   target_resource_group_id = data.ibm_resource_group.existing_resource_group.name
#   roles                    = ["SecretsReader"]
# }
